 ...
 * @private
 */
function _promptUser(message, callback) {
  inquirer.prompt([{
    type: 'password',
    message: message,
    name: 'password',
...
function _xcrypt(options, cipher, callback) {
  if (!options.password) {
    _promptUser('Enter the decryption password', function (password) {
...
module.exports.encrypt = function (options, callback) {
  _xcrypt(options, crypto.createCipher, callback);
};
...
module.exports.decrypt = function (options, callback) {
  _xcrypt(options, crypto.createDecipher, callback);
};
